...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h4 class="page-header">Filter Table </h4>
        </div>

        <div class="col-lg-12">
            <form class="form-inline" method="POST" action="orders_filter.php">
    ...
    <table class="table table-striped table-dark m-5">
        ...
        <tbody>
            ...
            $sqlOrder = "SELECT o.*,u.User_Name,u.Ext FROM `orders` o INNER JOIN `user` u where o.Uid=u.Uid";
